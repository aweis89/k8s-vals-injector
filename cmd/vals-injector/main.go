...
import (
	...
	mutating "github.com/aweis89/k8s-vals-injector/pkg/injector"
...
func (m *Main) Run() error {
	...
	go func() {
		...
		if _, exist := os.LookupEnv("SKIP_TLS"); exist {
			m.logger.Warningf("Skipping tls. No cert file found at %s", m.flags.CertFile)
